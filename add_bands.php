...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$band = $_POST['band_solo'];
	$bio = $_POST['band_biography'];
	$release = $_POST['band_release'];
	$namefolder = strtolower($band);
	
	$target_dir = "assets/img/bands/$namefolder/";
	...
	$sql_b = "SELECT id_band FROM bands WHERE band_name = '$band'";
	$sql = "INSERT INTO bands (band_name, biography, release_year, photo_url) VALUES ( '$band', '$bio', $release, '$target_file')";
...
<head>
    ...
    <title>SpotMusic - Add Bands</title>
    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                <h2 class="text-center"><strong>Add your own bands</strong></h2>
				<div class="form-group">
					<label>Band name(or solo): </label>
					<input class="form-control" type="text" name="band_solo" maxlength="50" required="">
				</div>
				<div class="form-group">
					<label>Band biography: </label>
					<textarea class="form-control" wrap="hard" name="band_biography" maxlength="600" minlength="100" required=""></textarea>
				</div>
                <div class="form-group">
					<label>Band release: </label>
					<input class="form-control" type="text" name="band_release" maxlength="4" minlength="4" pattern="\d{4}" required="">
				</div>
				<div class="form-group">
